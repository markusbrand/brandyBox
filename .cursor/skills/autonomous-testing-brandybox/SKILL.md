...
2. **Run E2E tests**
   - Set env: `BRANDYBOX_TEST_EMAIL`, `BRANDYBOX_TEST_PASSWORD` (required); optional: `BRANDYBOX_BASE_URL`, `BRANDYBOX_SYNC_FOLDER`, `BRANDYBOX_E2E_MAX_ATTEMPTS`
...
# E2E (set BRANDYBOX_TEST_EMAIL, BRANDYBOX_TEST_PASSWORD first)
